...
io.on("connection", socket => {
        ...
        //Balance
        setTimeout(()=>{
            console.log("emitting rebalance")
            socket.emit('Balance', MetaData.getMetaData(masterConnection));
        },20000);

        setTimeout(()=>{
            console.log("emitting end balance")
            socket.emit('End-Balance', MetaData.getMetaData(masterConnection));
        },80000);
